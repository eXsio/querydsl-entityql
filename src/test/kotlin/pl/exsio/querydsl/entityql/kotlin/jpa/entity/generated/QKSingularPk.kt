 ...
 */
 ...
 class QKSingularPk : QStaticModel<KSingularPk> {
     ...
     val compositeFks: ForeignKey<KCompositeFk> = run {
         ...
         val compositeFks = this.createInvForeignKey<KCompositeFk>(listOf(compositeFks0, compositeFks1), listOf("SPK_ID_1", "SPK_ID_2"))
         this.inverseJoinColumnsMap.put("compositeFks", compositeFks)
         compositeFks
      }

     val _primaryKey: PrimaryKey<KSingularPk> = run {
