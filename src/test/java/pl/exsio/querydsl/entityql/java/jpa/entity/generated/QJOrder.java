 ...
 public final class QJOrder extends QStaticModel<JOrder> {
     ...
     public QJOrder(String variable) {
         ...
         items: {
             ...
             this.items = this.<JOrderItem>createInvForeignKey(Arrays.<Path<?>>asList(items0), Arrays.asList("ITEM_ORDER_ID"));
         ...
         itemsReferenced: {
             ...
             this.itemsReferenced = this.<JOrderItem>createInvForeignKey(Arrays.<Path<?>>asList(itemsReferenced0), Arrays.asList("ITEM_ORDER_ID"));
