 ...
 public final class QJCompositeFk extends QStaticModel<JCompositeFk> {
     ...
     public QJCompositeFk(String variable) {
         ...
         compositePk: {
             ...
             this.compositePk = this.<JCompositePk>createForeignKey(Arrays.<Path<?>>asList(compositePk0, compositePk1), Arrays.asList("ID_1", "ID_2"));
         ...
         singularPk: {
             ...
             this.singularPk = this.<JSingularPk>createForeignKey(Arrays.<Path<?>>asList(singularPk0, singularPk1), Arrays.asList("ID_1", "ID_2"));
