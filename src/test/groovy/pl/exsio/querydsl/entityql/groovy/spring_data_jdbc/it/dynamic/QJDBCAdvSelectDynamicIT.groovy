package pl.exsio.querydsl.entityql.groovy.spring_data_jdbc.it.dynamic
...
class QJDBCAdvSelectDynamicIT extends Specification {
    ...
    def "should correctly use subQueries"() {
        given:
        Q<User> user = qEntity(User, scanner)
