 ...
 public final class QSingularPk extends QStaticModel<SingularPk> {
     ...
     public QSingularPk(String variable) {
         ...
         compositeFks: {
             ...
             this.compositeFks = this.<CompositeFk>createInvForeignKey(Arrays.<Path<?>>asList(compositeFks0, compositeFks1), Arrays.asList("SPK_ID_1", "SPK_ID_2"))
         ...
         _primaryKey: {
             ...
             this._primaryKey = this.<SingularPk>createPrimaryKey(pkArray)
         }
