package pl.exsio.querydsl.entityql.groovy.config
...
class SpringContext {
    ...
    static SQLQueryFactory queryFactory(DataSource dataSource, SQLTemplates sqlTemplates) {
        ...
        .registerEnumsByName("pl.exsio.querydsl.entityql.groovy.config.enums.by_name")
        .registerEnumsByOrdinal("pl.exsio.querydsl.entityql.groovy.config.enums.by_ordinal")
    }
