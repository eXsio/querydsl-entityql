...
import pl.exsio.querydsl.entityql.jdbc.entity.UpperCaseWithUnderscoresNamingStrategy
import pl.exsio.querydsl.entityql.jdbc.entity.it.*
...
public class QExporterSpringDataJdbcITSpec extends Specification {
    ...
    String pkgName = "pl.exsio.querydsl.entityql.jdbc.entity.it.generated"
