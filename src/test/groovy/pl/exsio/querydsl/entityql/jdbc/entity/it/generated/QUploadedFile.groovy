...
public final class QUploadedFile
    extends QStaticModel<pl.exsio.querydsl.entityql.jdbc.entity.it.UploadedFile> {
  ...
  public final PrimaryKey<pl.exsio.querydsl.entityql.jdbc.entity.it.UploadedFile> _primaryKey;
  ...
  public QUploadedFile(String variable) {
    super(
        pl.exsio.querydsl.entityql.jdbc.entity.it.UploadedFile.class,
        variable,
        "",
        "UPLOADED_FILES");
    ...
    _primaryKey:
    {
      ...
      this._primaryKey =
          this.<pl.exsio.querydsl.entityql.jdbc.entity.it.UploadedFile>createPrimaryKey(
