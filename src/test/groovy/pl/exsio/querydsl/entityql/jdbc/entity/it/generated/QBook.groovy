...
public final class QBook extends QStaticModel<pl.exsio.querydsl.entityql.jdbc.entity.it.Book> {
  ...
  public final PrimaryKey<pl.exsio.querydsl.entityql.jdbc.entity.it.Book> _primaryKey;
  ...
  public QBook(String variable) {
    super(pl.exsio.querydsl.entityql.jdbc.entity.it.Book.class, variable, "", "BOOKS");
    ...
    _primaryKey:
    {
      ...
      this._primaryKey =
          this.<pl.exsio.querydsl.entityql.jdbc.entity.it.Book>createPrimaryKey(
