...
public final class QGroupAdmin
    extends QStaticModel<pl.exsio.querydsl.entityql.jdbc.entity.it.GroupAdmin> {
  ...
  public final PrimaryKey<pl.exsio.querydsl.entityql.jdbc.entity.it.GroupAdmin> _primaryKey;
  ...
  public QGroupAdmin(String variable) {
    super(pl.exsio.querydsl.entityql.jdbc.entity.it.GroupAdmin.class, variable, "", "GROUP_ADMINS");
    ...
    _primaryKey:
    {
      ...
      this._primaryKey =
          this.<pl.exsio.querydsl.entityql.jdbc.entity.it.GroupAdmin>createPrimaryKey(
